...
public class StarTeamSCM extends SCM {
   ...
   * @param port           starteam port name
   * @param projectname    name of the project
   * @param viewname       name of the view
   * @param foldername     parent folder name.
   * @param username       the user name required to connect to starteam's server
...
//		return (StarTeamSCMDescriptorImpl)super.getDescriptor();
  ...
  public String getCacheagenthost() {
    return cacheagenthost;
  }

  public int getCacheagentport() {
